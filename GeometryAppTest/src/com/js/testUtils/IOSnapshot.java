...
public class IOSnapshot {
   ...
   *          warning is printed but no exception is thrown. This is useful when
  ...
  /**
   * Close the snapshot; stop capturing output, and verify with previously saved
   * output
   */
  ...
  /**
   * Examine stack trace to find the name of the calling unit test, and extract
   * the test name from it
   * 
